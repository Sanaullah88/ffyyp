...
class ScrapDestinationPage extends StatefulWidget {
  final ScrapModel scrapData;
  const ScrapDestinationPage({Key? key, required this.scrapData})
      : super(key: key);
  @override
  _ScrapDestinationPage createState() => _ScrapDestinationPage();
}

class _ScrapDestinationPage extends State<ScrapDestinationPage> {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(' ' + widget.scrapData.location,
                    ...
                    child: Row(
                      children: [
                        _globalWidget.createRatingBar(
                            rating: widget.scrapData.rating, size: 12),
                        Text('(' + widget.scrapData.review.toString() + ')',
                            style: TextStyle(fontSize: 11, color: _color2))
                      ],
                    ),
                  ),
                  Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(widget.scrapData.sale.toString() + ' Sale',
                        style: TextStyle(fontSize: 11, color: _color2)),
                  ),
                ],
              ),
